...
- Ergebnis soll in YAML gespeichert werden: `docs/mimir/cardinality-analysis.yaml`

## Copy/Paste Prompt für morgen

Du bist ein technischer Analyse-Agent. Führe eine kurze Cardinality-Analyse gegen Mimir durch und speichere das Ergebnis in `docs/mimir/cardinality-analysis.yaml`.
...
5. Speichere alles in YAML-Datei `docs/mimir/cardinality-analysis.yaml` gemäß Struktur unten.
