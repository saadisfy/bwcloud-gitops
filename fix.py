...
old_module_start = r'// --- Pipeline: Dual-Semantics \(Enrichment & Legacy Label Mirroring\) ---\s*declare "otelcol_pipeline_dual_semantics" \{'
...
# We will generate two modules.
# For pod_level, we keep k8sattributes.
# For meta_level, we remove k8sattributes and link promote_meta -> standardize_identity.

# Base processor string (the batch, mirror, standardize parts are identical)
